...
export default function TambahGedungPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSaving(true);
    setTimeout(() => {
      console.log("Data gedung baru:", formData);
      setIsSaving(false);
      setSaved(true);
      setTimeout(() => {
          ...
          <div className="mx-auto w-full max-w-[1200px] space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div className="flex min-w-0 items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 flex items-center gap-1.5 sm:gap-2">
                      <Building size={13} className="shrink-0 text-blue-400 sm:h-[14px] sm:w-[14px]" strokeWidth={2} />
                      <p className="text-xs leading-5 text-slate-500 sm:text-sm">
                        Lengkapi informasi gedung untuk ditambahkan ke sistem.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {saved && (
              <div className="flex items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
                ...
                <span>Gedung berhasil ditambahkan! Mengalihkan ke daftar gedung...</span>
              </div>
            )}
            ...
            <section className="rounded-2xl border border-slate-200 bg-white shadow-[0_2px_10px_rgba(15,23,42,0.04)] p-5 sm:p-6 lg:p-7">
              <div className="mb-5 flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Masukkan data gedung secara lengkap</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-900 outline-none transition-all focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >
            ...
            <div className="border-t border-slate-200/70 pt-4 text-center sm:pt-5">
              <p className="text-xs text-slate-400">© 2026 SmartSchool • Tambah Gedung - Sarana & Prasarana</p>
            </div>
          </div>
        </main>
      </div>
