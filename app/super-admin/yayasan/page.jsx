...
export default function DataYayasanPage() {
    ...
    // Warna status – tetap halus dan profesional
    ...
    return (
        // Pola wrapper disamakan persis dengan halaman Profil/Pengumuman/Dashboard/Manajemen Akses:
                    ...
                    <div className="w-full space-y-5 sm:space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div className="flex items-center gap-2.5 ml-[52px] sm:ml-0">
                                ...
                                <button
                                    onClick={() => router.push("/super-admin/yayasan/tambah")}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                            ...
                            <StatCard label="Total Sekolah" value={stats.totalSekolah} icon={School} color="violet" />
                        ...
                        <div className="bg-white rounded-xl border border-slate-200/80 p-4 shadow-sm">
                            <div className="flex flex-col gap-3">
                                <div className="relative w-full">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Cari nama yayasan, kode NPYP, atau ketua yayasan..."
                                        value={searchQuery}
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        className="px-3 py-1.5 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 text-slate-600 min-w-[90px]"
                                    >
                                    ...
                                    <table className="w-full text-sm">
                                        <thead>
                                            <tr className="bg-slate-50/80 border-b border-slate-200/80">
                                                ...
                                                <th className="hidden lg:table-cell px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Ketua Yayasan</th>
                                                <th className="hidden sm:table-cell px-4 py-3 text-left text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Jumlah Sekolah</th>
                                                ...
                                                paginatedData.map((item, index) => {
                                                    ...
                                                    return (
                                                        <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                                                            ...
                                                            <td className="hidden lg:table-cell px-4 py-3 text-slate-500 text-sm truncate max-w-[160px]">
                                                                {item.ketua}
                                                            </td>
                        ...
                        <div className="text-center text-xs text-slate-400/80 py-2 border-t border-slate-200/40">
                            © 2026 SmartSchool • Data Yayasan terakhir diperbarui hari ini
                        </div>
                    </div>
                </main>
            </div>
