          ...
          <div className="mx-auto w-full max-w-[1600px] space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            {saved && (
              <div className="flex items-center gap-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-sm text-emerald-800 sm:gap-3 sm:px-4 sm:py-3">
                ...
                <span className="text-xs sm:text-sm">Perubahan role berhasil disimpan.</span>
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              <div className="group rounded-2xl border border-slate-200 bg-white p-3.5 shadow-[0_2px_10px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-0.5 hover:shadow-[0_7px_20px_rgba(15,23,42,0.08)] sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-violet-50 text-violet-600 sm:h-9 sm:w-9">
                    <Users size={14} className="sm:h-[16px] sm:w-[16px]" />
                  </div>
                  <div className="min-w-0">
                    ...
                    <p className="text-base font-semibold tracking-tight text-slate-800 sm:text-lg">
                      {roleAsal.pengguna.toLocaleString("id-ID")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group rounded-2xl border border-slate-200 bg-white p-3.5 shadow-[0_2px_10px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-0.5 hover:shadow-[0_7px_20px_rgba(15,23,42,0.08)] sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-blue-600 sm:h-9 sm:w-9">
                    <Key size={14} className="sm:h-[16px] sm:w-[16px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.06em] text-slate-400">
                      Hak Akses Aktif
                    ...
                    <p className="text-base font-semibold tracking-tight text-slate-800 sm:text-lg">
                      {totalDipilih}/{totalPermissionTersedia}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group rounded-2xl border border-slate-200 bg-white p-3.5 shadow-[0_2px_10px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-0.5 hover:shadow-[0_7px_20px_rgba(15,23,42,0.08)] sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 sm:h-9 sm:w-9">
                    <Calendar size={14} className="sm:h-[16px] sm:w-[16px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.06em] text-slate-400">
                      Dibuat
              ...
              <div className="group rounded-2xl border border-slate-200 bg-white p-3.5 shadow-[0_2px_10px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-0.5 hover:shadow-[0_7px_20px_rgba(15,23,42,0.08)] sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-amber-50 text-amber-600 sm:h-9 sm:w-9">
                    <Clock size={14} className="sm:h-[16px] sm:w-[16px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.06em] text-slate-400">
                      Diperbarui
            ...
            <section className="rounded-2xl border border-slate-200 bg-white shadow-[0_2px_10px_rgba(15,23,42,0.04)] p-4 sm:p-5 lg:p-6">
              <div className="mb-4 flex items-center gap-2 border-b border-slate-100 pb-3 sm:mb-5 sm:gap-3 sm:pb-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-800">Detail Peran</p>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="flex items-end">
                  <div className="flex items-center gap-2 rounded-xl bg-slate-50 px-2 py-1.5 sm:px-3 sm:py-2">
                    <UserCheck size={13} className="text-slate-400 sm:h-[14px] sm:w-[14px]" />
                    <p className="text-xs text-slate-500">
                      {roleAsal.pengguna.toLocaleString("id-ID")} pengguna sedang menggunakan peran ini.
                    </p>
                  </div>
                </div>
              </div>
