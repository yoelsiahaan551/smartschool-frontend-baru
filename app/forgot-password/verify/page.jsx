...
export default function VerifikasiPage() {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      // Simpan token jika backend langsung
      // memberikan token setelah verifikasi.
      if (data?.token) {
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                disabled={loading}
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-center text-lg font-bold tracking-[0.45em] text-slate-800 outline-none transition placeholder:text-sm placeholder:font-normal placeholder:tracking-normal placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 disabled:bg-slate-50"
              />

              <p className="mt-2 text-center text-[11px] text-slate-400">
                Kode OTP berlaku sesuai
                waktu yang ditentukan server.
              </p>
            </div>
