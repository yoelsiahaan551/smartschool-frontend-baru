  ...
  return (
    <>
      ...
      <aside className={asideClasses}>
        ...
        {/* =============================================
            HEADER SIDEBAR — LOGO DARI public/logo/
            ============================================= */}
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex flex-col leading-tight min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[10px] text-blue-200/70 font-medium tracking-wider uppercase whitespace-nowrap">
                    {config.brandName}
                  </span>

                  {/* Crown hanya untuk role selain Guru dan Siswa */}
                  {role !== "guru" && role !== "siswa" && (
                    <Crown
                      size={12}
                      className="text-yellow-400/80 ml-0.5 flex-shrink-0"
                    />
                  )}
                </div>
              </div>
        ...
        >
          {menuSections.map((item, index) => {
            ...
            const isActive =
              pathname === item.path || isChildActive;
