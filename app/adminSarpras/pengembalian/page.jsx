...
// Dummy data pengembalian. Ganti dengan data asli dari API kalau sudah ada.
const pengembalianList = [
  { id: "pjm-001", nama: "Proyektor Epson", tipe: "Inventaris", peminjam: "Pak Budi", tanggalKembali: "22 Agu 2026", kondisiKembali: "-", status: "Belum Dikembalikan" },
  { id: "pjm-004", nama: "Lapangan Basket", tipe: "Fasilitas", peminjam: "Pak Rudi", tanggalKembali: "19 Agu 2026", kondisiKembali: "-", status: "Belum Dikembalikan" },
  { id: "pjm-005", nama: "Mikroskop", tipe: "Inventaris", peminjam: "Bu Dewi", tanggalKembali: "6 Agu 2026", kondisiKembali: "-", status: "Terlambat" },
  { id: "pjm-003", nama: "Sound System", tipe: "Inventaris", peminjam: "Bu Sari", tanggalKembali: "12 Agu 2026", kondisiKembali: "Baik", status: "Sudah Dikembalikan" },
  { id: "pjm-006", nama: "Lab Komputer", tipe: "Fasilitas", peminjam: "Pak Anwar", tanggalKembali: "1 Agu 2026", kondisiKembali: "Baik", status: "Sudah Dikembalikan" },
  { id: "pjm-007", nama: "Kursi Kayu (10 unit)", tipe: "Inventaris", peminjam: "Panitia 17-an", tanggalKembali: "17 Agu 2026", kondisiKembali: "Rusak Ringan", status: "Sudah Dikembalikan" },
];

const tipeOptions = ["Semua", "Inventaris", "Fasilitas"];
const statusOptions = ["Semua", "Belum Dikembalikan", "Terlambat", "Sudah Dikembalikan"];
...
const quickStats = [
  { key: "belum", label: "Belum Dikembalikan", value: pengembalianList.filter((p) => p.status === "Belum Dikembalikan").length, icon: Clock, tone: "text-blue-600 bg-blue-50" },
  { key: "terlambat", label: "Terlambat", value: pengembalianList.filter((p) => p.status === "Terlambat").length, icon: AlertTriangle, tone: "text-rose-600 bg-rose-50" },
  { key: "selesai", label: "Sudah Dikembalikan", value: pengembalianList.filter((p) => p.status === "Sudah Dikembalikan").length, icon: CheckCircle2, tone: "text-emerald-600 bg-emerald-50" },
];
...
export default function PengembalianPage() {
  ...
  const handleOpenDetail = (id) => {
    router.push(`/adminSarpras/pengembalian/${id}`);
  };
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Pantau dan proses pengembalian barang atau ruangan yang dipinjam.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/70 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between gap-2 px-5 py-4 border-b border-slate-100">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-sm font-semibold text-slate-800 truncate">Daftar Pengembalian</h3>
                    <p className="text-xs text-slate-400">{filteredList.length} data ditemukan</p>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-xs text-slate-400 border-b border-slate-100">
                      ...
                      <th className="px-5 py-3 font-medium">Kondisi Kembali</th>
                    ...
                    {filteredList.map((p) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-5 py-3.5 text-slate-600">{p.kondisiKembali}</td>
                          <td className="px-5 py-3.5">
