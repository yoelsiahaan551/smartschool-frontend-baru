...
const HelpButton = () => (
    <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm border border-slate-200/50">
        <div className="flex items-center gap-2">
            <HelpCircle className="w-4 h-4 text-blue-400" />
            <span className="text-xs sm:text-sm text-slate-500 whitespace-nowrap">Butuh bantuan?</span>
        </div>
        <a
            href="mailto:admin@portalpelanggan.id"
            className="text-xs sm:text-sm text-blue-500 font-medium hover:text-blue-600 transition-colors"
        >
            ...
            {steps.map((step, index, arr) => (
                <div key={index} className="flex items-center">
                    <div className="flex flex-col items-center">
                        ...
                        <span
                            className={`text-[10px] sm:text-xs font-medium mt-1.5 text-center whitespace-nowrap ${
                    ...
                    {index < arr.length - 1 && (
                        <div
                            className={`w-4 sm:w-12 h-0.5 mx-0.5 sm:mx-2 ${
    ...
    return (
        <div className="flex flex-col items-end gap-0.5">
            ...
            <div className="flex items-baseline gap-1">
                <span className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-800 font-mono tabular-nums">
                    {hours}
                </span>
                ...
                <span className="text-xs sm:text-sm font-medium text-slate-400 ml-1">WIB</span>
            </div>
        ...
        <div className={`${poppins.className} min-h-screen bg-white`}>
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-10">
                ...
                <header className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 mb-7">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] sm:text-sm text-slate-400 font-medium tracking-wide -mt-0.5">
                ...
                <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/40 border border-slate-200/50 overflow-hidden transition-all hover:shadow-2xl hover:shadow-slate-200/60">
                    {/* — Status Header — */}
                    <div className="bg-gradient-to-r from-blue-400 to-indigo-400 px-4 sm:px-8 py-4 sm:py-7">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <div className="flex items-center gap-3">
                                    <p className="text-blue-50 text-xs sm:text-sm font-medium tracking-wide">
                                        STATUS PENDAFTARAN
                                    </p>
                                    <span className="w-px h-5 bg-blue-300/30" />
                                    <div className="flex items-center gap-1.5 text-blue-100/80 text-[10px] sm:text-xs font-mono">
                                ...
                                <p className="text-blue-50/80 text-xs sm:text-sm mt-1.5 max-w-2xl leading-relaxed">
                            ...
                            <div className="flex-shrink-0">
                                <div className="bg-white/15 backdrop-blur-sm rounded-full px-3 py-1.5 sm:px-4 sm:py-2 flex items-center gap-2 border border-white/10">
                                    <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-blue-200 animate-pulse" />
                    ...
                    {/* — Progress Steps — */}
                    <div className="px-4 sm:px-8 pt-6 pb-2 border-b border-slate-200/50">
                        <ProgressSteps />
                    </div>
                    ...
                    <div className="p-4 sm:p-8">
                        <div className="flex flex-col lg:flex-row gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="bg-slate-50/60 rounded-xl border border-slate-200/50 overflow-hidden">
                                    <div className="divide-y divide-slate-200/50">
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 py-2.5 sm:py-3 hover:bg-white/50 transition-colors gap-1 sm:gap-0">
                                            <span className="text-[11px] sm:text-sm text-slate-500 font-medium">
                                                Kode Tagihan
                                            </span>
                                            <span className="text-[11px] sm:text-sm font-mono font-bold text-slate-800 bg-white px-2 sm:px-3 py-0.5 sm:py-1 rounded-md border border-slate-200/50">
                                                SBI - 2025 - 08118
                                            </span>
                                        </div>
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 py-2.5 sm:py-3 hover:bg-white/50 transition-colors gap-1 sm:gap-0">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 py-2.5 sm:py-3 bg-amber-50/40 hover:bg-amber-50/60 transition-colors gap-1 sm:gap-0">
                                            <span className="text-[11px] sm:text-sm text-slate-500 font-medium">
                                                Status
                                            </span>
                                            <span className="inline-flex items-center gap-1.5 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-sm font-medium bg-amber-100/80 text-amber-700 border border-amber-200/50">
                            ...
                            {/* Kanan — Aksi (Otomatis menjadi full-width di Mobile) */}
                            <div className="lg:w-72 flex-shrink-0 w-full">
                                <div className="bg-gradient-to-br from-blue-50/50 to-indigo-50/50 rounded-xl border border-blue-200/50 p-6 h-full flex flex-col">
                                    ...
                                    <div className="space-y-3 flex-1 flex flex-col items-stretch lg:items-end">
                                        <button
                                            onClick={handleUpload}
                                            disabled={isUploading || isUploaded}
                                            className={`w-full lg:w-auto min-w-[180px] flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
                                                isUploaded
                                        ...
                                        <a
                                            href="mailto:admin@portalpelanggan.id"
                                            className="w-full lg:w-auto min-w-[180px] flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium bg-white border border-slate-200/50 text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200"
                                        >
                ...
                {/* ===== FOOTER ===== */}
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between text-[10px] sm:text-xs text-slate-400 gap-2">
