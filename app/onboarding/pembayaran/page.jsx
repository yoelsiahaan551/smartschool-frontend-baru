...
// ========== Tombol Bantuan ==========
const HelpButton = () => (
    <div className="flex items-center gap-2 bg-white shadow-sm px-5 py-2.5 rounded-full border border-slate-200/80 hover:shadow-md transition-shadow">
        <HelpCircle className="w-4 h-4 text-slate-400" />
        <span className="text-sm text-slate-600">Butuh bantuan?</span>
        <a
            href="mailto:admin@portalpelanggan.id"
            className="text-slate-800 font-medium hover:text-slate-900 transition-colors"
        >
            ...
            {steps.map((step, index, arr) => (
                <div key={index} className="flex items-center">
                    <div className="flex flex-col items-center">
                        <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/20">
                            <step.icon className="w-5 h-5" />
                        </div>
                        <span className="text-xs font-medium mt-2 text-center text-slate-700 max-w-[70px] leading-tight">
                            {step.label}
                        </span>
                    </div>
                    {index < arr.length - 1 && (
                        <div className="w-8 sm:w-16 h-0.5 mx-1 sm:mx-2 bg-gradient-to-r from-emerald-500 to-teal-500" />
                    )}
                </div>
            ))}
        </div>
        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div className="bg-white rounded-2xl shadow-2xl shadow-slate-200/60 border border-slate-200/80 overflow-hidden transition-all hover:shadow-3xl hover:shadow-emerald-200/30">
                    ...
                    <div className="relative bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-600 px-8 py-8 overflow-hidden">
                        {/* Efek dekoratif */}
                        ...
                        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <div className="flex items-center gap-3">
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-white text-xs font-medium border border-white/10">
                                        <Sparkles className="w-3.5 h-3.5" />
                                        BERHASIL
                                    </span>
                                </div>
                                <h2 className="text-2xl sm:text-3xl font-bold text-white mt-2 flex items-center gap-2">
                                    Pembayaran Berhasil & Akun Aktif
                                    <CheckIcon className="w-6 h-6 text-white/80" />
                                </h2>
                            ...
                            <div className="flex-shrink-0">
                                <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 flex items-center gap-2 border border-white/20 shadow-lg">
                    ...
                    {/* — Progress Steps — */}
                    <div className="px-6 sm:px-8 pt-8 pb-4 border-b border-slate-200/60">
                        <ProgressSteps />
                    </div>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="bg-slate-50/80 rounded-xl border border-slate-200/60 overflow-hidden">
                                    <div className="divide-y divide-slate-200/60">
                                        <div className="flex items-center justify-between px-5 py-4 hover:bg-white/50 transition-colors">
                                            <span className="text-sm text-slate-500 font-medium">
                                                Kode Tagihan
                                            </span>
                                            <div className="flex items-center gap-2">
                                                <span className="text-sm font-mono font-bold text-slate-800 bg-white px-3 py-1.5 rounded-lg border border-slate-200/60">
                                                    SCH-2026-08110
                                                </span>
                                                <button
                                                    onClick={handleCopy}
                                        ...
                                        <div className="flex items-center justify-between px-5 py-4 bg-emerald-50/50 hover:bg-emerald-50/70 transition-colors">
                                            <span className="text-sm text-slate-500 font-medium">
                                                Status
                                            </span>
                                            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm font-bold bg-emerald-100 text-emerald-700 border border-emerald-200/80 shadow-sm">
                    ...
                    {/* — Footer Card — */}
                    <div className="px-6 sm:px-8 py-4 bg-slate-50/50 border-t border-slate-200/60">
